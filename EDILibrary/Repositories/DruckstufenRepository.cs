...
namespace EDILibrary.Repositories
{
    ...
    public class DruckstufenRepository : GenericRepository<BaseKeyValue>
    {
        public override List<BaseKeyValue> GetValueList(bool allowNullValue = true)
        {
            ...
            liste.AddRange(new List<BaseKeyValue>(){
                new BaseKeyValue(){ Key = "Y03",Value="Niederdruck"},    
                new BaseKeyValue(){ Key = "Y02",Value="Mitteldruck"},
                new BaseKeyValue(){ Key = "Y01",Value="Hochdruck"},
