        ...
        public static string GetDescription(string name)
        {
            ...
            var attrs =
                (IEnumerable<Attribute>)
                    typeof(EDIEnums)
                        .GetRuntimeField(DescriptionMap[name])
                        .GetCustomAttributes(typeof(EDIDescriptionAttribute), false);
            ...
            var attrs =
                (IEnumerable<Attribute>)
                    enumValue
                        ...
                        .GetCustomAttributes(typeof(APERAKDescriptionAttribute), false);
