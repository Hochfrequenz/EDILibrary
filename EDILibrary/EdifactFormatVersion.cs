...
namespace EDILibrary
{
    ...
    public static class EdifactFormatHelper
    {
        ...
        public static EdifactFormat FromPruefidentifikator(
            string pruefidentifikator,
            bool maskUTILMDX = true,
        ...
        )
        {
            ...
            if (
                formatPackage is not null
                && formatPackage >= EdifactFormatVersion.FV2310
                && pruefidentifikator.StartsWith("11")
            )
            {
            ...
            foreach (EdifactFormat ef in Enum.GetValues(typeof(EdifactFormat)))
            {
                ...
                {
                    return maskUTILMDX && ef is EdifactFormat.UTILMDG or EdifactFormat.UTILMDS
            ...
            throw new NotImplementedException(
                $"No matching EdiFormat found for Prüfidentifikator {pruefidentifikator}"
            );
        }
    }
    ...
    public enum EdifactFormatVersion
    {
        ...
        /// <summary>
        /// Format Version valid since October 2025
        /// </summary>
        FV2510,
    ...
    public static class EdifactFormatVersionExtension
    {
        ...
        public static int CompareToVersion(
            this EdifactFormatVersion edifactFormatVersion,
            EdifactFormatVersion compare
        )
        {
        ...
        public static EdifactFormatVersion ToEdifactFormatVersion(this string legacyFormatString)
        {
            ...
            throw new NotImplementedException(
                $"The legacy format string '{legacyFormatString}' could not be mapped."
            );
        }
    }
    ...
    public class EdifactFormatVersionHelper : IEdifactFormatVersionProvider
    {
        ...
        /// <summary>
        /// validity start date of <see cref="EdifactFormatVersion.FV2604"/>
        /// </summary>
        private static readonly DateTime KeyDate2604 = new(
            2026,
            03,
            31,
            22,
        ...
        public EdifactFormatVersion GetFormatVersion(EdifactFormat format, string version)
        {
            EdifactFormatVersion determinedVersion = format switch
            {
                ...
                {
                    "1.0g" => EdifactFormatVersion.FV2604,
                    "1.0f" => EdifactFormatVersion.FV2510,
                    "1.0e" => EdifactFormatVersion.FV2504,
                    "1.0d" => EdifactFormatVersion.FV2404,
                    "1.0c" => EdifactFormatVersion.FV2310,
                ...
                {
                    "2.8e" => EdifactFormatVersion.FV2510,
                ...
                {
                    "2.9e" => EdifactFormatVersion.FV2604,
                    "2.9d" => EdifactFormatVersion.FV2510,
                ...
                {
                    "1.3c" => EdifactFormatVersion.FV2510,
                    "1.3a" => EdifactFormatVersion.FV2504,
                    "1.3" => EdifactFormatVersion.FV2310,
                    "1.2" => EdifactFormatVersion.FV2210,
